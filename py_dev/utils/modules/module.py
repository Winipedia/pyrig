...
from py_dev.utils.modules.inspection import (
    get_qualname_of_obj,
    get_unwrapped_obj,
)
...
def get_executing_module() -> ModuleType:
    ...
    E.g. if you run `python -m py_dev.setup` from the command line,
    then the executing module is py_dev.modules.setup
