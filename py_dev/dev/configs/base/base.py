...
import py_dev
from py_dev.dev import configs
from py_dev.utils.iterate import nested_structure_is_subset
from py_dev.utils.modules.class_ import (
...
from py_dev.utils.modules.package import DependencyGraph, get_src_package
from py_dev.utils.string import split_on_uppercase
...
class ConfigFile(ABC):
    ...
    def get_all_subclasses(cls) -> set[type["ConfigFile"]]:
        ...
        pkgs_depending_on_this = DependencyGraph().get_all_depending_on(
            py_dev.__name__, include_self=True
        )
        ...
        for pkg in pkgs_depending_on_this:
            configs_pkg_name = configs.__name__.replace(
                py_dev.__name__, pkg.__name__, 1
            )
    ...
    def init_config_files(cls) -> None:
        ...
        # Some must be first:
        from py_dev.dev.configs.builder import (  # noqa: PLC0415
            BuilderConfigFile,
        )
        from py_dev.dev.configs.configs import (  # noqa: PLC0415
            ConfigsConfigFile,
        )
        from py_dev.dev.configs.gitignore import (  # noqa: PLC0415
            GitIgnoreConfigFile,
        )
        from py_dev.dev.configs.pyproject import (  # noqa: PLC0415
            PyprojectConfigFile,
        )
