...
from py_dev.dev.configs.base.base import TomlConfigFile
from py_dev.dev.configs.experiment import ExperimentConfigFile
from py_dev.utils.os.os import run_subprocess
from py_dev.utils.projects.poetry.dev_deps import DEV_DEPENDENCIES
from py_dev.utils.projects.poetry.versions import VersionConstraint
...
class PyprojectConfigFile(TomlConfigFile):
    ...
    def get_configs(cls) -> dict[str, Any]:
        """Get the config."""
        from py_dev.dev.cli import (  # noqa: PLC0415
            cli,
        )
