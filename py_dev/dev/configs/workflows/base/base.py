...
from py_dev.dev.cli.subcommands import build, protect_repo
from py_dev.dev.configs.base.base import YamlConfigFile
from py_dev.dev.configs.pyproject import PyprojectConfigFile
from py_dev.utils.modules.package import get_src_package
from py_dev.utils.projects.poetry.poetry import (
    get_poetry_run_py_dev_cli_cmd_script,
)
from py_dev.utils.string import (
    make_name_from_obj,
    split_on_uppercase,
)
...
class Workflow(YamlConfigFile):
    ...
    def step_run_tests(
        ...
        *,
        ...
        if step is None:
            step = {}
        if PyprojectConfigFile.get_package_name() == py_dev.__name__:
    ...
    def step_protect_repository(
        ...
        *,
        ...
        return cls.get_step(
            ...
            run=get_poetry_run_py_dev_cli_cmd_script(
                cmd=protect_repo,
            ),
    ...
    def step_build_artifacts(
        ...
        *,
        ...
        return cls.get_step(
            ...
            run=get_poetry_run_py_dev_cli_cmd_script(build),
            step=step,
        )
