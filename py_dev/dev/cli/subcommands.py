...
from py_dev.dev.artifacts.build import build as build_cmd
from py_dev.setup import setup as setup_cmd
from py_dev.utils.git.github.repo.protect import (
    protect_repository as protect_repo_cmd,
)
from py_dev.utils.projects.create_root import create_root as create_root_cmd
from py_dev.utils.testing.create_tests import create_tests as create_tests_cmd
