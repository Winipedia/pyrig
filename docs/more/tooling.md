...
**Setup Required**:
- Account required: Visit [codecov.io](https://codecov.io) and log in with GitHub
- Token recommended: Add `CODECOV_TOKEN` to repository secrets, or enable tokenless upload in Codecov settings
