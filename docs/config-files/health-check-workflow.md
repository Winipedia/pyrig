...
- **Secret:** `CODECOV_TOKEN` (optional for public repos)
- **Why:** Tracks coverage trends over time

**Note:** This step doesn't fail the workflow if Codecov upload fails (optional service).
...
- **Required:** No (optional for public repos, required for private repos)
- **How to create:**
...
**Symptom:** Coverage upload step fails

**Cause:** Private repository without CODECOV_TOKEN

**Solution:**

This is expected and doesn't fail the workflow. To fix:
1. Sign up at codecov.io
2. Add repository
3. Add `CODECOV_TOKEN` to repository secrets

Or the step will continue to fail silently (by design).
