...
│       ├── release.yml                     # CD: tagging, GitHub release
...
- **`.scratch.py`** is version-control-ignored and created locally.
  ...
  You can run the file to experiment with code snippets with the `pyrig scratch`
  command.
- **`.github/settings.json`** is read by the deploy workflow to apply repository
