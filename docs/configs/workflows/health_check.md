...
**Needs**: `health_check_matrix` (waits for matrix to complete)  
...
**Why aggregate?** GitHub branch protection can require this single job instead of tracking all matrix combinations individually.
