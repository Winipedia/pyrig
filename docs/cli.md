...
Simply run `pyrig mkcmd <command-name>` to create or update the module `my_project.rig.cli.subcommands`
...
it will create or update `shared_subcommands` and add the command skeleton there.
