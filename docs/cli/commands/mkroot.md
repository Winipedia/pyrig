...
The `all_config_files_correct` autouse fixture runs before tests and triggers this
command if any config files are incorrect. See
[Autouse Fixtures](../../tests/autouse.md#all_config_files_correct) for details.
