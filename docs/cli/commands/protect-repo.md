...
The branch protection rules are defined in `branch-protection.json`, which is automatically generated by pyrig when you run:
...
See [branch-protection.json documentation](../../configs/branch_protection.md) for details on the configuration structure and customization.
