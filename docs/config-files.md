...
A correctly placed subclass skeleton is generated for you. If you already know
the module and class, skip the prompt with `pyrig mk subcls <module> <class>`.
Override whichever methods need changing — the rest of the behavior is
inherited.
