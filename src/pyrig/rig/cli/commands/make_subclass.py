...
def choose_subclass() -> type[DependencySubclass]:
    ...
    formats them for display (concrete classes use the string representation of
    a default-constructed instance, abstract classes use their qualified name),
    sorts them alphabetically by
