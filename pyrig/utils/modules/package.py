...
def get_src_package() -> ModuleType:
    ...
    """
    from pyrig.utils.modules.module import to_path  # noqa: PLC0415
    from pyrig.utils.testing.convention import TESTS_PACKAGE_NAME  # noqa: PLC0415
...
def get_modules_and_packages_from_package(
    ...
    from pyrig.utils.modules.module import (  # noqa: PLC0415
...
def copy_package(
    ...
    *,
    ...
    """
    from pyrig.utils.modules.module import create_module, to_path  # noqa: PLC0415
...
def get_main_package() -> ModuleType:
    ...
    """
    from pyrig.utils.modules.module import (  # noqa: PLC0415  # avoid circular import
        to_module_name,
    )
...
def import_pkg_from_path(package_dir: Path) -> ModuleType:
    ...
    from pyrig.utils.modules.module import to_module_name  # noqa: PLC0415
