...
Example:
    ...
    >>> SecurityChecker.get_run_args().run()
    >>> SecurityChecker.get_run_recursive_args(".").run()
"""
...
class SecurityChecker(Tool):
    ...
    Example:
        >>> SecurityChecker.get_run_args("-r", ".").run()
        >>> SecurityChecker.get_run_with_config_args().run()
    """
