...
Generates {package_name}/dev/tools/__init__.py with pyrig.dev.tools docstring
...
class ToolsInitConfigFile(InitConfigFile):
    ...
    Generates __init__.py with pyrig.dev.tools docstring for tool wrapper
    ...
    def get_src_module(cls) -> ModuleType:
        ...
        Returns:
            ModuleType: pyrig.dev.tools module.
