...
tests.test_py_dev.test_modules.test_package
"""
...
from py_dev.utils.modules.package import (
    DependencyGraph,
    copy_package,
    find_packages,
...
def test_get_src_package() -> None:
    ...
    assert_with_msg(
        src_pkg.__name__ == py_dev.__name__,
        f"Expected py_dev, got {src_pkg}",
    )
...
def test_find_packages(mocker: MockFixture) -> None:
    ...
    mock_find_packages = mocker.patch(
        "py_dev.utils.modules.package._find_packages",
...
def test_find_packages_with_namespace(mocker: MockFixture) -> None:
    ...
    mock_find_namespace = mocker.patch(
        "py_dev.utils.modules.package._find_namespace_packages",
...
def test_find_packages_as_modules(mocker: MockFixture) -> None:
    ...
    mock_import = mocker.patch("py_dev.utils.modules.package.import_module")
...
def test_copy_package(mocker: MockFixture) -> None:
    ...
    mock_get_isolated_name = mocker.patch(make_obj_importpath(get_isolated_obj_name))
    mock_create_module = mocker.patch(make_obj_importpath(create_module))
    mock_get_content = mocker.patch(make_obj_importpath(get_module_content_as_str))
    ...
    # Mock walk_package
    mock_walk = mocker.patch(make_obj_importpath(walk_package))
...
def test_copy_package_without_content(mocker: MockFixture) -> None:
    ...
    mock_to_path = mocker.patch(make_obj_importpath(to_path))
    mock_get_isolated_name = mocker.patch(make_obj_importpath(get_isolated_obj_name))
    mocker.patch(make_obj_importpath(create_module))
    mock_get_content = mocker.patch(make_obj_importpath(get_module_content_as_str))
...
def test_get_main_package(mocker: MockFixture) -> None:
    ...
    mocker.patch("py_dev.utils.modules.package.sys", mock_sys)

    mock_import_module = mocker.patch("py_dev.utils.modules.package.import_module")
