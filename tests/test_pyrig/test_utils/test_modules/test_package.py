...
from pyrig.utils.modules.package import (
    DependencyGraph,
    copy_package,
    find_packages,
...
def test_find_packages(mocker: MockFixture) -> None:
    ...
    mock_find_packages = mocker.patch(
        "pyrig.utils.modules.package._find_packages",
...
def test_find_packages_with_namespace(mocker: MockFixture) -> None:
    ...
    mock_find_namespace = mocker.patch(
        "pyrig.utils.modules.package._find_namespace_packages",
...
def test_find_packages_as_modules(mocker: MockFixture) -> None:
    ...
    mock_import = mocker.patch("pyrig.utils.modules.package.import_module")
...
def test_get_main_package(mocker: MockFixture) -> None:
    ...
    mocker.patch("pyrig.utils.modules.package.sys", mock_sys)

    mock_import_module = mocker.patch("pyrig.utils.modules.package.import_module")
