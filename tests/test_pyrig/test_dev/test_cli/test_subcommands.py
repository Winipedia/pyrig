...
def test_mkroot() -> None:
    ...
    args = Pyrigger.get_cmd_args(mkroot, "--help")
...
def test_mktests() -> None:
    ...
    # run --help comd to see if its available
    args = Pyrigger.get_cmd_args(mktests, "--help")
    stoud = args.run().stdout.decode("utf-8")
...
def test_mkinits() -> None:
    ...
    # run --help comd to see if its available
    args = Pyrigger.get_cmd_args(mkinits, "--help")
    stoud = args.run().stdout.decode("utf-8")
...
def test_init() -> None:
    """Test func for setup."""
    # run --help comd to see if its available
    args = Pyrigger.get_cmd_args(init, "--help")
    stoud = args.run().stdout.decode("utf-8")
...
def test_build() -> None:
    """Test func for build."""
    # run --help comd to see if its available
    args = Pyrigger.get_cmd_args(build, "--help")
    stoud = args.run().stdout.decode("utf-8")
...
def test_protect_repo() -> None:
    ...
    # run --help comd to see if its available
    args = Pyrigger.get_cmd_args(protect_repo, "--help")
    stoud = args.run().stdout.decode("utf-8")
